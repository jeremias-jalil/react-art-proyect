...
export default function AutorArt(props) {
    ...
    useEffect(()=>dispatch(searchCuadrosArtistas(props.match.params.artistName)),[])
    useEffect(()=>dispatch(searchCuadrosArtistas(props.match.params.artistName)),[props.match.params.artistName])

    return (
        <div>
            {!loading ? <Cuadros cuadros={cuadrosArtist}/> : <Loading />}
