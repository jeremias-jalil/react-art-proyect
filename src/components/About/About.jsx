    ...
    return (
        <div className={style.div}>
            ...
            <div className={style.content}><h1>Practice app</h1>
                <h2>This is a development by Jeremías Jalil, used as a practice of the concepts acquired on Reac, Redux, Route, API conection, fornt persistence and CSS module, in the Full Stack Web Developer Bootcamp</h2>
