...
export default function Detalle(props) {
  ...
  let fav =
    favourite.filter((e) => e.objectID === cuadro.objectID).length === 0;
    ...
    <div className={style.div}>
      ...
      <div className={style.divImg}>
        <InnerImageZoom
          className={style.img}
          zoomType="click"
          src={cuadro.primaryImageSmall}
          zoomSrc={cuadro.primaryImage}
        />
      </div>
      <div className={style.divCont}>
        <div className={style.divInfo}>
          ...
          <h2>Autor: </h2>
          <Link
            to={`/artist/${cuadro.artistDisplayName}`}
            className={style.link}
          >
            {cuadro.artistDisplayName}
          </Link>
          <h2>Autor Bio: </h2>
          ...
          <button
            className={fav ? style.button : style.buttonOff}
            onClick={() => dispatch(add_favourite(cuadro))}
          >
            Add favourite
          </button>
          <button
